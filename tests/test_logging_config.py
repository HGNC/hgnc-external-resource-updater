"""Tests for the logging_config module in the hgnc-external-resource-updater service."""
...
from hgnc_external_resource_updater.logging_config import configure_logging, get_logger
